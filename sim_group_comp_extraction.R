...
# 
result_dimest = array(0, dim = c(nrep,nsub,3,3), dimnames = list(NULL,NULL,SVAR = c('High SVAR', 'Medium SVAR', 'Low SVAR'), 
...
for (i in 1:nrep) result_dimest[i,,,] = result[[i]]
save(result_dimest, file = 'result_dimest.RData')
#apply(result_dimest,c(2,3,4),mean)
